...
JSON Web Tokens (JWT) are used to authenticate access to storage in the Open Science Data Federation (OSDF) . JWTs are used to authenticate users and authorize access to resources, including storage in the cluster. Nautilus is able to manage your JWTs for you, refreshing and resigning tokens as needed using the OSG’s token operator .
...
- The location of the public key, usually on a website (this is the issuer)

- The keyid of the public key

- The algorithm used to sign the JWT

- Scopes that should be included in the JWT, such as “storage.write:/”, “storage.read:/”, etc.
